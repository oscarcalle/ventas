...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, (_objectSpread2 = {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              _context2.n = 1;
              return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_6__.loadStripe)("".concat(_this4.stripe_key));
            case 1:
    ...
    if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
      this.timer = setTimeout(function () {
        ...
        if (product_filter.length === 1) {
          _this19.Check_Product_Exist(product_filter[0], product_filter[0].id);
        } else {
    ...
    axios.get("pos/data_create_pos").then(function (response) {
      ...
      _this21.client_name = response.data.default_client_name;
      _this21.getProducts();
      if (response.data.defaultWarehouse != "") {
        _this21.Get_Products_By_Warehouse(response.data.defaultWarehouse);
      }
